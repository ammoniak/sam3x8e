...
#[doc = r" Proxy"]
pub struct _IBCTLDACCOREW<'a> {
    w: &'a mut W,
}
impl<'a> _IBCTLDACCOREW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 3;
...
impl W {
    ...
    #[doc = "Bits 8:9 - Bias Current Control for DAC Core"]
    #[inline]
    pub fn ibctldaccore(&mut self) -> _IBCTLDACCOREW {
        _IBCTLDACCOREW { w: self }
    }
}
