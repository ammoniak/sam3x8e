...
impl W {
    ...
    #[inline]
    pub fn rb_rise(&mut self) -> _RB_RISEW {
        _RB_RISEW { w: self }
    }
    #[doc = "Bit 5 - Ready Busy Falling Edge Detection Interrupt Disable"]
    #[inline]
    pub fn rb_fall(&mut self) -> _RB_FALLW {
        _RB_FALLW { w: self }
    }
