...
impl W {
    ...
    #[inline]
    pub fn tovf(&mut self) -> _TOVFW {
        _TOVFW { w: self }
    }
    #[doc = "Bit 23 - TimeStamp Interrupt Disable"]
    #[inline]
    pub fn tstp(&mut self) -> _TSTPW {
        _TSTPW { w: self }
    }
    ...
    #[inline]
    pub fn serr(&mut self) -> _SERRW {
        _SERRW { w: self }
    }
    #[doc = "Bit 26 - Acknowledgment Error Interrupt Disable"]
    #[inline]
    pub fn aerr(&mut self) -> _AERRW {
        _AERRW { w: self }
    }
