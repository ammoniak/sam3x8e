#[doc = "Writer for register DEVEPTIDR0_ISOENPT"]
pub type W = crate::W<u32, super::DEVEPTIDR0_ISOENPT>;
...
#[doc = "Write proxy for field `MDATEC`"]
pub struct MDATEC_W<'a> {
    w: &'a mut W,
}
impl<'a> MDATEC_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl W {
    ...
    #[inline(always)]
    pub fn mdatec(&mut self) -> MDATEC_W {
        MDATEC_W { w: self }
    }
